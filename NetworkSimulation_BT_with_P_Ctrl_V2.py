...
# BusyTone
BT_us = 9  # us
NUM_BT = 1 # 각 STA은 해당 변수에 맞춰. BT 경쟁을 수행
#BT == 1 -> BT 사용 x
#BT > 2 -> BT 사용 O
NUM_BT_ACC = 0 # throughput 계산 시 BT overhead 계산을 위해 사용

OPTIMAL_COL_RATE = 0.6 # 최적의 충돌 확률
...
def allocationRA_RU():
    for sta in stationList:
        if (sta.bo <= 0):  # 백오프 타이머가 0보다 작아졌을 때
            ...
            sta.priory = random.randrange(0, NUM_BT) # Busytone 우선 순위 할당
        else:
